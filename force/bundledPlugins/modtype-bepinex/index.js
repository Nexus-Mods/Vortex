...
/***/ ((module) => {
  ...
  /* eslint-disable security/detect-unsafe-regex */
      ...
      function arrayType (values) {
        const contentType = tomlType(values[0])
  ...
  // mixed integer/float, emit as floats
      ...
      function stringifyInlineArray (values) {
        ...
        let result = '['
        const stringified = values.map(_ => stringifyInline(_, type))
...
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
      ...
      function ensureBepInExPack(api, gameMode, force, isUpdate) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const injectorModIds = Object.keys(mods).filter(id => { let _a; return ((_a = mods[id]) === null || _a === void 0 ? void 0 : _a.type) === common_1.MODTYPE_BIX_INJECTOR; });
          ...
          const forceUpdate = (dwnl) => (0, bepInExDownloader_1.ensureBepInExPack)(api, gameId, true)
            ...
            .finally(() => {
              ...
              const newInjector = Object.keys(newMods)
                .find(id => { let _a; return ((_a = newMods[id].attributes) === null || _a === void 0 ? void 0 : _a.fileId) === dwnl.fileId; });
              const batched = [
