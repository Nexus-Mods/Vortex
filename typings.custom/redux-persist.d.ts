...
// Source: https://raw.githubusercontent.com/pellejacobs/typed-redux-persist/78616886cb5ebe7108b4e1b2b7d445abda35e287/constants.d.ts
...
declare module 'redux-persist/constants' {
import main = require('~redux-persist/constants');
export = main;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/reactjs/redux/d18a977260cf29d49499781367f56353ebd9697a/index.d.ts
declare module '~redux-persist~redux' {
/**
...
module ReduxPersist {
   ...
   */
  function persistStore<S>(store: Store<S>, config?: PersistStoreConfig<S>, callback?: (err, state) => void): Persistor
...
declare module 'redux-persist/index' {
import main = require('~redux-persist/index');
export = main;
}
