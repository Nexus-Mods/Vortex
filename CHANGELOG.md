...
- Scripted FOMOD installs failing on Windows because the IPC host (`ModInstallerIPC.exe`) was missing from the packaged build ([#TODO](https://github.com/Nexus-Mods/Vortex/pull/TODO))
