...
type IProps = Omit<ISettingsDebugProps, "readThemes"> & {
  themes: string[];
} & IConnectedProps &
  IActionProps;
      ...
      <Grid fluid key={lastUpdated}>
        ...
        <Row>
          <Table condensed>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <div ref={this.headingXlSemiRef} className="heading-xl-semi">
                    heading-xl-semi
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div ref={this.headingLgSemiRef} className="heading-lg-semi">
                    heading-lg-semi
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div ref={this.headingMdSemiRef} className="heading-md-semi">
                    heading-md-semi
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div ref={this.headingSmSemiRef} className="heading-sm-semi">
                    heading-sm-semi
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div ref={this.headingXsSemiRef} className="heading-xs-semi">
                    heading-xs-semi
                  </div>
                </td>
        ...
        <Row>
          ...
          <Col sm={4} md={4} lg={4}>
            ...
            <h2 ref={this.h2Ref}>
              <code>h2</code>Heading 2 {this.h2Styles?.fontSize}
            </h2>
            <h3 ref={this.h3Ref}>
              <code>h3</code>Heading 3 {this.h3Styles?.fontSize}
            </h3>
            <h4 ref={this.h4Ref}>
              <code>h4</code>Heading 4 {this.h4Styles?.fontSize}
            </h4>
            <h5 ref={this.h5Ref}>
              <code>h5</code>Heading 5 {this.h5Styles?.fontSize}
            </h5>
            <h6 ref={this.h6Ref}>
              <code>h6</code>Heading 6 {this.h6Styles?.fontSize}
            </h6>
          </Col>
...
export default withTranslation(["common"])(
  connect(mapStateToProps, mapDispatchToProps)(SettingsDebugWrapper),
) as React.ComponentClass<ISettingsDebugProps>;
