/**
 * Validates the TypeScript ESP parser against expected output from the C++ esptk.
 * The expected output was generated by benchmark-baseline.ts.
 */
  ...
  for (const expected of expectedOutputs) {
    ...
    describe(expected.file, () => {
      ...
      it("masterList matches", () => {
        // C++ esptk uses std::set (sorted order), TS parser preserves file order.
