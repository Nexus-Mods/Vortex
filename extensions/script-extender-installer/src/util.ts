...
const getGameStore = (gameId:string, api: types.IExtensionApi): string|undefined => selectors.discoveryByGame(api.getState(), gameId)['store'];
...
export { getGameStore, getScriptExtenderVersion, getGamePath, toBlue, clearNotifications, ignoreNotifications };