...
export const HALO_GAMES: { [key: string]: IHaloGame } = {
  halo1: {
    ...
    name: "Halo: CE",
    modsPath: "halo1",
    img: path.join(__dirname, "halo1.png"),
  },
  halo2: {
    internalId: "2",
    name: "Halo 2",
    modsPath: "halo2",
    img: path.join(__dirname, "halo2.png"),
  },
  halo3: {
    internalId: "3",
    name: "Halo 3",
    modsPath: "halo3",
    img: path.join(__dirname, "halo3.png"),
  },
  ...
  odst: {
    ...
    name: "ODST",
    modsPath: "halo3odst",
    img: path.join(__dirname, "odst.png"),
  },
  halo4: {
    internalId: "5",
    name: "Halo 4",
    modsPath: "halo4",
    img: path.join(__dirname, "halo4.png"),
  },
  haloreach: {
    internalId: "6",
    name: "Reach",
    modsPath: "haloreach",
    img: path.join(__dirname, "haloreach.png"),
  },
};
