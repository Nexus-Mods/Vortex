...
//#region extensions/games/game-pathfinderwrathoftherighteous/index.ts
...
async function resolveGameVersion(discoveryPath) {
	...
	try {
		const segments = (await fs.readFileAsync(versionFilepath, { encoding: "utf8" })).split(" ");
...
function main(context) {
	...
	context.once(() => {
		if (context.api.ext.ummAddGame !== void 0) context.api.ext.ummAddGame({
			gameId: GAME_ID,
