/**
 * Imperative install hooks for the Pathfinder: Wrath of the Righteous GDL
 * extension.
 *
 ...
 *
 * These hooks are game-agnostic; the Kingmaker extension uses an identical copy.
 * The per-game audio and portrait paths live in game.yaml.
 */
