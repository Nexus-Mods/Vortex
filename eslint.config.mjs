...
export default defineConfig([
  ...
  {
    name: "Platform-agnostic packages - no platform-specific imports",
    files: ["src/shared/src/**/*.{ts,js,mjs,cjs}", "packages/paths/src/**/*.{ts,js,mjs,cjs}"],
    rules: {
          ...
          patterns: [
            {
              regex: "^node:",
              message:
                "Node.js built-ins are not allowed in platform-agnostic packages.",
            },
            {
              regex: "^electron(/|$)",
              message:
                "Electron is not allowed in platform-agnostic packages.",
            },
          ],
          paths: [
            ...
            ...[
              ...
              name,
              message: `'${name}' is a Node.js built-in and is not allowed in platform-agnostic packages.`,
            })),
          ],
        },
      ],
