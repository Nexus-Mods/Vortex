...
// @public (undocumented)
const getMod: ((state: IState, gameId: string, modId: string | number) => IMod) &
    OutputSelectorFields<
        (
            args_0: {
                [modId: string]: IMod;
...
// @public (undocumented)
const getModInstallPath: ((state: IState, gameId: string, modId: string | number) => string) &
    OutputSelectorFields<
...
// @public (undocumented)
const isCollectionModPresent: ((state: IState, collectionSlug: string) => boolean) &
    OutputSelectorFields<
        (
            args_0: {
                [modId: string]: IMod;
...
// @public
function makeOverlayableDictionary<KeyT extends string | number | symbol, ValueT>(
