...
import { activeGameId, lastActiveProfileForGame } from '../src/extensions/profile_management/selectors';
...
jest.mock('../src/util/ComponentEx', () => {
...
describe('UpdateSet', () => {
  ...
  describe('Adding Entries', () => {
    ...
    it('should add managed load order entries', () => {
      ...
      const updateSet = new UpdateSet(mockApi, isFBLO);
      updateSet.init('gameId');
      const entry = { modId: 'mod1', id: '1', name: 'Test Mod', enabled: true, index: 0 };
  ...
  describe('Restoring Load Order', () => {
    it('should restore load order correctly', () => {
      ...
      const expected = [
        ...
        { id: '2', fileId: 2, modId: 'mod2', name: 'Mod 2', enabled: true, index: 3 },
        { id: '1', fileId: 1, modId: 'mod1', name: 'Mod 1', enabled: true, index: 4 },
  ...
  describe('Finding Entries', () => {
    it('should find an entry by modId', () => {
      ...
      const found = updateSet.findEntry({ modId: 'mod1', id: '1', name: 'Test Mod', enabled: true });
