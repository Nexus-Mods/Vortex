...
namespace FomodInstaller.ModInstaller
{
    ...
    /// <param name="gameSpecificStopFolders">The list of game specific stop folders.</param>
		...
		Task<Dictionary<string, object>> Install(List<string> modArchiveFileList, List<string> gameSpecificStopFolders, string destinationPath, ProgressDelegate progressDelegate,
