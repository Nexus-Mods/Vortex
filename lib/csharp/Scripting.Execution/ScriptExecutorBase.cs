...
namespace Scripting
{
	...
	/// simpler.
	/// </remarks>
	public abstract class ScriptExecutorBase : IScriptExecutor, IDisposable
	{
		#region Events

		/// <summary>
		/// Raised when a task in the set has started. This has to be triggered by the implementation,
		/// so when and if this event is triggered depends on the script type
		/// </summary>
		/// <remarks>
