import * as actions from "../renderer/actions/app";
...
export const appReducer: IReducerSpec = {
  reducers: {
    [actions.setStateVersion as any]: (state, payload) =>
      setSafe(state, ["version"], payload),
    ...
    [actions.setExtensionEnabled as any]: (state, payload) =>
      setSafe(
        state,
        ["extensions", payload.extensionId, "enabled"],
        payload.enabled,
      ),
    [actions.setExtensionVersion as any]: (state, payload) =>
      setSafe(
        state,
        ["extensions", payload.extensionId, "version"],
        payload.version,
      ),
    [actions.setExtensionEndorsed as any]: (state, payload) =>
      setSafe(
        state,
        ["extensions", payload.extensionId, "endorsed"],
        payload.endorsed,
      ),
