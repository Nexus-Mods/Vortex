...
function mapStateToProps(state: IState): IConnectedProps {
  return {
    ...
    visibleDialog: state.session.dialog,
    mainPage: state.session.mainPage,
    secondaryPage: state.session.secondaryPage,
    activeProfileId: state.settings.profiles.activeProfileId,
    nextProfileId: state.settings.profiles.nextProfileId,
    progressProfile: getSafe(state, ['session', 'progress', 'profile'], {}),
    ...
    uiBlockers: state.session.uiBlockers,
