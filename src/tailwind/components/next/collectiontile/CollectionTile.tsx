          ...
          <div className="flex-1 self-stretch flex flex-col justify-start items-start">
            ...
            {displayTags.length > 0 && (
              <div className="self-stretch pl-3 flex flex-col justify-start items-start gap-2">
                <div className="self-stretch py-1.5 border-t border-b border-stroke-neutral-translucent-weak inline-flex justify-start items-center gap-1.5 flex-wrap content-center">
            ...
            <div className="self-stretch pl-3 inline-flex justify-start items-center gap-5">
              <div className="flex-1 py-1.5 border-b border-stroke-neutral-translucent-weak flex justify-start items-center gap-5">
                {/* Endorsements */}
            ...
            <div className="self-stretch flex-1 pl-3 py-1 flex flex-col justify-start items-start gap-2">
              <Typography
                ...
                appearance="subdued"
                className="line-clamp-4 wrap-break-word leading-tight"
              >
                {description}
              </Typography>
            </div>
