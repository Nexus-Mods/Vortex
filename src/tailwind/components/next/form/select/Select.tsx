      ...
      >
        <select
          ...
          className={joinClasses([
            ...
            !!errorMessage
              ? "border-danger-strong hover:border-stroke-neutral-translucent-subdued"
              : "border-stroke-neutral-translucent-subdued",
            "hover:border-stroke-neutral-translucent-strong",
            "focus:bg-surface-low focus:border-stroke-neutral-translucent-strong focus-visible:outline-offset-1",
          ])}
          disabled={disabled}
          id={id}
          required={required}
