...
import { InstallUninstalledCard } from "./cards/InstallUninstalledCard";
import { OrCard } from "./cards/OrCard";
import { ReplaceCard } from "./cards/ReplaceCard";
      ...
      <div className="space-y-6">
        {report.requirements.map((requirement) => {
          switch (requirement.kind) {
            ...
            case "or":
              return (
                <OrCard ctx={ctx} key={requirement.requirementDefId} requirement={requirement} />
              );
          }
        })}
      </div>
