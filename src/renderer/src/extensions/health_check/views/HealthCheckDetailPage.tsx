      ...
      <MainPage.Body>
        <div className="h-full space-y-6 overflow-y-auto p-6">
          <div className="flex items-center justify-between gap-x-6">
            ...
            <Button buttonType="secondary" leftIconPath={mdiArrowLeft} size="sm" onClick={onBack}>
              {t("common:::back")}
            </Button>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <FileRequirement
                    actions={
                      <Button buttonType="secondary" size="sm" onClick={() => console.log("todo")}>
                        View in loadout
                      </Button>
                    }
                    file={mockCurrent}
