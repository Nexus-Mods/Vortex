...
// keep the real fs wrapper but make directory watching inert: a real FSWatcher on the temp
...
vi.mock("../../../util/fs", async (importOriginal) => ({
  ...
  watch: () => ({ close: () => undefined, on: () => undefined }) as unknown as fsModule.FSWatcher,
}));

import type * as fsModule from "../../../util/fs";
import type { IPluginLoadOrderEntry } from "../types/IPluginLoadOrderEntry";
import PluginPersistor, { type PluginFormat } from "./PluginPersistor";
