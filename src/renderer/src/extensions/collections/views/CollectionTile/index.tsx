...
class CollectionThumbnail extends ComponentEx<IProps, { updating: boolean }> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <Panel bsStyle={active ? "primary" : "default"} className={classes.join(" ")}>
        <Panel.Body className="collection-thumbnail-body">
          {details === true ? (
            <NewRevisionMarker collection={collection} t={t} updating={this.state.updating} />
          ) : null}

          <Image circle={false} className="thumbnail-img" srcs={this.imageURLs(collection)} />
