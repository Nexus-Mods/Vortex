...
import { IGameVersion } from "@nexusmods/nexus-api";
...
function HealthIndicator(props: IHealthIndicatorProps) {
  ...
  return (
    <FlexLayout className="collection-health-indicator" type="column">
      <div className="collection-health-header">
        <div className="collection-health-header-title">
          <Icon name="revision" set="collections" />
      ...
      <FlexLayout className="collection-health-body" type="row">
          ...
          <FlexLayout type="column">
            {!voteAllowed ? (
              ...
              <>
                ...
                <FlexLayout.Fixed>
                  <FlexLayout className="collection-voting-pill" type="row">
                    <FlexLayout.Fixed>
                      <tooltip.Button
                        className={
