...
describe("setInstallPath", () => {
  it("sets the install path for a game", () => {
    ...
    let result = settingsReducer.reducers.SET_MOD_INSTALL_PATH(input, {
      gameId: "gameId1",
      path: "New path",
    });
...
describe("setActivator", () => {
  it("sets the activator to use for this game", () => {
    ...
    let result = settingsReducer.reducers.SET_ACTIVATOR(input, {
      gameId: "gameId1",
...
describe("removeMod", () => {
  it("removes the mod", () => {
    ...
    let result = modsReducer.reducers.REMOVE_MOD(input, {
      gameId: "gameId1",
      modId: "modId1",
    });
...
describe("setModInstallationPath", () => {
  it("sets the mod installation path", () => {
    ...
    let result = modsReducer.reducers.SET_MOD_INSTALLATION_PATH(input, {
      gameId: "gameId1",
      modId: "modId1",
...
describe("setModAttribute", () => {
  it("sets the mod attribute", () => {
    ...
    let result = modsReducer.reducers.SET_MOD_ATTRIBUTE(input, {
      gameId: "gameId1",
      modId: "modId1",
...
describe("setModAttributes", () => {
  it("sets the mod attributes", () => {
    ...
    let result = modsReducer.reducers.SET_MOD_ATTRIBUTES(input, {
      gameId: "gameId1",
      modId: "modId1",
      attributes: {
...
describe("setModState", () => {
  it("sets the mod state", () => {
    ...
    let result = modsReducer.reducers.SET_MOD_STATE(input, {
      gameId: "gameId1",
      modId: "modId1",
      modState: "new value",
    });
...
describe("addMod", () => {
  it("adds a new mod", () => {
    ...
    let result = modsReducer.reducers.ADD_MOD(input, {
      gameId: "gameId1",
      mod: mod,
    });
