...
describe("setToolVisible", () => {
  it("sets the tool visible", () => {
    let input = {
      discovered: { gameId1: { tools: { toolId1: { hidden: false } } } },
    };
    let result = settingsReducer.reducers.SET_TOOL_VISIBLE(input, {
      gameId: "gameId1",
      toolId: "toolId1",
      value: true,
    });
    expect(result).toEqual({
      discovered: { gameId1: { tools: { toolId1: { hidden: true } } } },
    });
  });
  it("adds the new tool and set it visible if the tool doesn't exist", () => {
    ...
    expect(result).toEqual({
      discovered: {
        gameId1: {
          tools: { toolId1: { hidden: false }, toolId2: { hidden: true } },
        },
      },
    });
  });
  it("creates a new game and add the new visible tool under if the game doesn't exist", () => {
    ...
    expect(result).toEqual({
      discovered: {
        gameId1: { tools: { toolId1: { hidden: false } } },
        gameId2: { tools: { toolId1: { hidden: true } } },
      },
    });
  });
  it("affects only the right game", () => {
    let input = {
      discovered: {
        gameId1: { tools: { toolId1: { hidden: false } } },
        gameId2: { tools: { toolId1: { hidden: false } } },
      },
    };
    let result = settingsReducer.reducers.SET_TOOL_VISIBLE(input, {
      gameId: "gameId1",
    ...
    expect(result).toEqual({
      discovered: {
        gameId1: { tools: { toolId1: { hidden: true } } },
        gameId2: { tools: { toolId1: { hidden: false } } },
      },
    });
  });
...
describe("setGameHidden", () => {
  it("sets the game hidden", () => {
    ...
    let result = settingsReducer.reducers.SET_GAME_HIDDEN(input, {
      gameId: "gameId1",
      hidden: true,
    });
  ...
  it("creates a new game and set it visible if the game doesn't exist", () => {
    ...
    expect(result).toEqual({
      discovered: { gameId1: { hidden: false }, gameId2: { hidden: true } },
    });
  });
  it("affects only the right game", () => {
    let input = {
      discovered: { gameId1: { hidden: false }, gameId2: { hidden: false } },
    };
    let result = settingsReducer.reducers.SET_GAME_HIDDEN(input, {
      gameId: "gameId1",
      hidden: true,
    ...
    expect(result).toEqual({
      discovered: { gameId1: { hidden: true }, gameId2: { hidden: false } },
    });
  });
});
...
describe("setGameParameters", () => {
  it("sets the game parameters", () => {
    ...
    let result = settingsReducer.reducers.SET_GAME_PARAMETERS(input, {
      gameId: "gameId1",
  ...
  it("affects only the right game", () => {
    ...
    expect(result).toEqual({
      discovered: { gameId1: gameParameters, gameId2: oldGameParameters },
    });
  });
});
...
describe("addDiscoveredGame", () => {
  it("updates the discovered game params", () => {
    let input = {
      discovered: { gameId1: { path: "path1", modPath: "modPath1" } },
    };
    let game = {
      path: "path2",
      modPath: "modPath2",
    };
    let result = settingsReducer.reducers.ADD_DISCOVERED_GAME(input, {
      id: "gameId1",
      result: game,
    });
  ...
  it("affects only the right game", () => {
    let input = {
      discovered: {
        gameId1: { path: "path1", modPath: "modPath1" },
        gameId2: { path: "path1", modPath: "modPath1" },
      },
    };
    let game = {
      path: "path2",
...
describe("addDiscoveredTool", () => {
  it("updates the discovered tool params", () => {
    ...
    let result = settingsReducer.reducers.ADD_DISCOVERED_TOOL(input, {
      gameId: "gameId1",
      toolId: "toolId1",
      result: parameters,
    });
    ...
    expect(result).toEqual({
      discovered: { gameId1: { tools: { toolId1: parameters } } },
    });
  });
  it("affects only the right game", () => {
    let input = {
    ...
    expect(result).toEqual({
      discovered: {
        gameId1: { tools: { toolId1: parameters } },
        gameId2: { tools: { toolId1: oldParameters } },
      },
    });
  });
});
