import settingsReducer from "../extensions/settings_metaserver/reducers";
...
describe("addMetaserver", () => {
  it("adds a Metaserver", () => {
    ...
    let result = settingsReducer.reducers.ADD_METASERVER(input, {
      id: "id1",
      url: "new url",
    });
...
describe("removeMetaserver", () => {
  it("removes a Metaserver", () => {
    ...
    let result = settingsReducer.reducers.REMOVE_METASERVER(input, {
      id: "id1",
