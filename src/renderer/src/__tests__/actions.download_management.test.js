...
describe("addLocalDownload", () => {
  it("creates the action", () => {
    ...
    expect(action).toEqual({
      ...
      payload: { id: "id", game: "game", localPath: "localPath", fileSize: 42 },
    });
  });
});
...
describe("downloadProgress", () => {
  it("creates the action", () => {
    ...
    expect(action).toEqual({
      ...
      payload: { id: "id", received: 42, total: 43 },
    });
  });
});
...
describe("finishDownload", () => {
  it("creates the action", () => {
    ...
    expect(action).toEqual({
      ...
      payload: { id: "id", state: "state", failCause: "failCause" },
    });
  });
});
...
describe("initDownload", () => {
  it("creates the action", () => {
    let action = actions.initDownload(
      "id",
      ["url1", "url2"],
      { key: "value" },
      ["game"],
...
describe("setDownloadHash", () => {
  it("creates the action", () => {
    ...
    expect(action).toEqual({
      error: false,
      type: "SET_DOWNLOAD_HASH",
      payload: { id: "id", fileMD5: "hash" },
    });
  });
});
...
describe("setDownloadHashByFile", () => {
  it("creates the action", () => {
    ...
    expect(action).toEqual({
      ...
      payload: { fileName: "filePath", fileMD5: "hash", fileSize: 42 },
    });
  });
});
