...
export const setModArchiveId = safeCreateAction(
  "SET_MOD_ARCHIVEID",
  (gameId: string, modId: string, archiveId: string) => ({
    gameId,
    modId,
    archiveId,
  }),
 ...
 */
export const setModState = safeCreateAction(
  "SET_MOD_STATE",
  (gameId: string, modId: string, modState: ModState) => ({
    gameId,
    modId,
    modState,
  }),
 ...
 */
export const setModInstallationPath = safeCreateAction(
  "SET_MOD_INSTALLATION_PATH",
  (gameId: string, modId: string, installPath: string) => ({
    gameId,
    modId,
    installPath,
  }),
 ...
 */
export const setModAttribute = safeCreateAction(
  "SET_MOD_ATTRIBUTE",
 ...
 */
export const setModType = safeCreateAction(
  "SET_MOD_TYPE",
  (gameId: string, modId: string, type: string) => ({ gameId, modId, type }),
);

export const clearModRules = safeCreateAction(
  "CLEAR_MOD_RULE",
  (gameId: string, modId: string) => ({ gameId, modId }),
);
 ...
 */
export const removeModRule = safeCreateAction(
  "REMOVE_MOD_RULE",
  (gameId: string, modId: string, rule: IModRule) => ({ gameId, modId, rule }),
);
 ...
 */
export const setFileOverride = safeCreateAction(
  "SET_FILE_OVERRIDE",
  (gameId: string, modId: string, files: string[]) => ({
    gameId,
    modId,
    files,
  }),
