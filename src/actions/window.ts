 ...
 */
export const setWindowSize = createAction('STORE_WINDOW_SIZE');

/**
 * action to set window position in the store.
 * Takes one parameter of the form {x: number, y: number}
 */
export const setWindowPosition = createAction('STORE_WINDOW_POSITION');
 ...
 */
export const setMaximized = createAction('SET_MAXIMIZED');
