  ...
  return (
    <form>
      <FormGroup>
        <ControlLabel>
          {t(
            "Vortex should have opened the following url in your default browser. " +
...
class LoginDialog extends ComponentEx<IProps, ILoginDialogState> {
      ...
      >
        <Modal.Body ref={this.mModalRef}>
          <IconButton
            ...
            icon="close"
          />
          {troubleshoot ? this.renderTroubleshoot() : this.renderRegular()}
        </Modal.Body>
      </Modal>
    );
  }
      ...
      <div className="login-content">
        ...
        {visible && oauthPending === undefined ? (
          ...
          [
            ...
            <a key="troubleshoot-button" onClick={this.troubleshoot}>
          ...
          <div>
            ...
            <p>
              {t(
                "Copy the following address into your browser window. We support Chrome, Safari, Firefox and Edge.",
              )}
            </p>
      ...
      <div className="login-content">
        ...
        <ol style={{ textAlign: "left" }}>
          <li>
            <p>
              {t(
                "Copy the following address into your browser and log in/register if required (skip this step if you already have the token). We support Chrome, Safari, Firefox and Edge.",
              )}
            </p>
          ...
          <li>
            <p>
              {t(
                'Click "Authorise" on the website and you will be given a token, copy and paste the token below and click save.',
              )}
            </p>
  ...
  private applyKey = async () => {
    try {
      ...
      this.context.api.showErrorNotification("Invalid token", err, {
        allowReport: false,
      });
    }
  };
...
function mapDispatchToProps(
  ...
  return {
    ...
    onShowLoginError: (message: string) =>
      dispatch(showDialog("error", "Error", { message }, [{ label: "Close" }])),
