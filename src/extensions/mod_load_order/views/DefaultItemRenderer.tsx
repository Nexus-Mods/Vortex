...
class DefaultItemRenderer extends ComponentEx<IProps, {}> {
  ...
  public render() {
    ...
    return !!item.locked ? this.renderLocked(item) : this.renderDraggable(item);
  }
  ...
  private renderDraggable(item: ILoadOrderDisplayItem): JSX.Element {
    ...
    const checkBox = () =>
      !!itemRendererOptions?.displayCheckboxes ? (
        <Checkbox
...
const empty = {};
const defaultRendererOpts: IItemRendererOptions = {
  listViewType: "full",
...
export default withTranslation(["common"])(
  connect(mapStateToProps, mapDispatchToProps)(DefaultItemRenderer) as any,
