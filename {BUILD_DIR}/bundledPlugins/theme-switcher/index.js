...
exports["default"] = (0, react_i18next_1.withTranslation)(['common'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(SettingsThemeWrapper));
...
class ColorPreview extends React.Component {
    ...
    render() {
        ...
        const popover = (React.createElement(react_bootstrap_1.Popover, { id: 'color-preview' },
            React.createElement(react_color_1.ChromePicker, { color: color, disableAlpha: true, onChangeComplete: this.onUpdate })));
        const content = (React.createElement("div", null,
            colorToHex(color),
            renderColorBox(color)));
        return disabled ? content : (React.createElement(react_bootstrap_1.OverlayTrigger, { trigger: 'click', rootClose: true, placement: 'top', overlay: popover }, content));
    }
}
const colorDefaults = [
...
const settingsReducer = {
    reducers: {
        [actions.selectTheme]: (state, payload) => vortex_api_1.util.setSafe(state, ['currentTheme'], payload),
    },
    defaults: {
