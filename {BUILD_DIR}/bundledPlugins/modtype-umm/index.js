...
const winapi = isWindows() ? __webpack_require__(/*! winapi-bindings */ "winapi-bindings") : undefined;
function ensureUMM(api, gameMode, force) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ummModIds = Object.keys(mods).filter(id => { var _a; return ((_a = mods[id]) === null || _a === void 0 ? void 0 : _a.type) === 'umm'; });
...
function readRegistryKey(hive, key, name) {
    var _a;
    try {
        const instPath = (_a = winapi === null || winapi === void 0 ? void 0 : winapi.RegGetValue) === null || _a === void 0 ? void 0 : _a.call(winapi, hive, key, name);
        if (!instPath) {
...
function setUMMPath(api, resolvedPath, gameId) {
    ...
    const validTools = Object.keys(tools)
        .filter(key => { var _a; return !!((_a = tools[key]) === null || _a === void 0 ? void 0 : _a.path); })
        .map(key => tools[key]);
...
function validateIUMMGameConfig(data) {
    var res = (0, types_validate_1.default)(data);
