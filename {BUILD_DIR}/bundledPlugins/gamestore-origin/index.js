...
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
      ...
      exports.MissingXMLElementError = void 0;
      ...
      const xml2js_1 = __webpack_require__(/*! xml2js */ "../../node_modules/xml2js/lib/xml2js.js");
      const queryParser = __webpack_require__(/*! querystring */ "querystring");
      ...
      class MissingXMLElementError extends Error {
      ...
      exports.MissingXMLElementError = MissingXMLElementError;
      class OriginLauncher {
        constructor() {
          ...
          if (process.platform === 'win32') {
            try {
              const clientPath = winapi.RegGetValue('HKEY_LOCAL_MACHINE', 'SOFTWARE\\WOW6432Node\\Origin', 'ClientPath');
              this.mClientPath = Promise.resolve(clientPath.value);
            }
            catch (err) {
              (0, vortex_api_1.log)('info', 'Origin launcher not found', { error: err.message });
        ...
        launchGame(appId) {
          return this.getPosixPath(appId)
            .then(posPath => vortex_api_1.util.opn(posPath).catch(err => {
              (0, vortex_api_1.log)('debug', 'Origin game launch failed', err);
        ...
        findByAppId(appId) {
          ...
          return this.allGames()
            ...
            .then(entry => entry === undefined
              ? Promise.reject(new vortex_api_1.types.GameEntryNotFound(Array.isArray(appId)
        ...
        findByName(namePattern) {
          ...
          return this.allGames()
            ...
            .then(entry => entry === undefined
              ? Promise.reject(new vortex_api_1.types.GameEntryNotFound(namePattern, STORE_ID))
              : Promise.resolve(entry));
        }
        getGameStorePath() {
          return (!!this.mClientPath)
        ...
        getGameName(installerPath, manifestType) {
          return __awaiter(this, void 0, void 0, function* () {
            const installerData = yield vortex_api_1.fs.readFileBOM(installerPath, 'utf8');
            let xmlDoc;
            try {
              xmlDoc = yield (0, xml2js_1.parseStringPromise)(installerData);
            }
            catch (err) {
        ...
        parseLocalContent() {
          ...
          const allEntries = [];
          return (0, turbowalk_1.default)(localData, entries => {
            allEntries.push(...entries);
          })
            .then(() => {
              const manifests = allEntries.filter(manifest => path.extname(manifest.filePath) === MANIFEST_EXT);
              return Bluebird.reduce(manifests, (accum, manifest) => vortex_api_1.fs.readFileAsync(manifest.filePath, { encoding: 'utf-8' })
                .then(data => {
                  let query;
                  try {
                    ...
                    (0, vortex_api_1.log)('error', 'failed to parse manifest file', err);
                    return accum;
                  }
                  if (!!query.dipinstallpath && !!query.id) {
                    const gamePath = query.dipinstallpath;
                    const appid = query.id;
                    const installerFilepath = path.join(gamePath, INSTALLER_DATA);
                    return vortex_api_1.fs.statAsync(installerFilepath).then(() => Bluebird.any([this.getGameName(installerFilepath, 'DiPManifest'),
                      ...
                      .catch(err => {
                        if ((err.code === 'ENOENT')
                          ...
                          (0, vortex_api_1.log)('debug', 'Origin game manifest found, but does not appear to be installed', appid);
                          return accum;
                        }
                        const meta = Array.isArray(err)
                          ? err.map(errInst => errInst.message).join(';')
                          : err;
                        (0, vortex_api_1.log)('error', `failed to find game name for ${appid}`, meta);
                        return accum;
                      });
                  }
                  return accum;
            ...
            .catch(err => {
              if (!['ENOTFOUND', 'ENOENT'].includes(err.code)) {
                (0, vortex_api_1.log)('error', 'failed to read origin directory', { error: err.message, code: err.code });
              }
              return [];
            });
        }
      ...
      function main(context) {
        const instance = process.platform === 'win32' ? new OriginLauncher() : undefined;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        "use strict";
        let builder, defaults, escapeCDATA, requiresCDATA, wrapCDATA,
        ...
        exports.Builder = (function() {
          ...
          Builder.prototype.buildObject = function(rootObj) {
            let attrkey, charkey, render, rootElement, rootName;
            ...
            render = (function(_this) {
              return function(element, obj) {
                let attr, child, entry, index, key, value;
      ...
      (function() {
        ...
        exports.Parser = (function(superClass) {
          ...
          Parser.prototype.reset = function() {
            let attrkey, charkey, ontext, stack;
            ...
            this.saxParser.onopentag = (function(_this) {
              return function(node) {
                let key, newValue, obj, processedKey, ref;
            ...
            this.saxParser.onclosetag = (function(_this) {
              return function() {
                let cdata, emptyStr, key, node, nodeName, obj, objClone, old, s, xpath;
                obj = stack.pop();
                nodeName = obj["#name"];
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let assign, getValue, isArray, isEmpty, isFunction, isObject, isPlainObject,
          slice = [].slice,
          hasProp = {}.hasOwnProperty;

        assign = function() {
          let i, key, len, source, sources, target;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let NodeType, XMLAttribute, XMLNode;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let XMLDOMConfiguration, XMLDOMErrorHandler, XMLDOMStringList;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let NodeType, WriterState, XMLAttribute, XMLCData, XMLComment, XMLDTDAttList, XMLDTDElement, XMLDTDEntity, XMLDTDNotation, XMLDeclaration, XMLDocType, XMLDocument, XMLDocumentCB, XMLElement, XMLProcessingInstruction, XMLRaw, XMLStringWriter, XMLStringifier, XMLText, getValue, isFunction, isObject, isPlainObject, ref,
          hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLDocumentCB = (function() {
          ...
          XMLDocumentCB.prototype.createChildNode = function(node) {
            let att, attName, attributes, child, i, len, ref1, ref2;
            switch (node.type) {
              case NodeType.CData:
          ...
          XMLDocumentCB.prototype.element = function(name, attributes, text) {
            let child, i, len, oldValidationFlag, ref1, root;
          ...
          XMLDocumentCB.prototype.instruction = function(target, value) {
            let i, insTarget, insValue, len, node;
            this.openCurrent();
            if (target != null) {
      ...
      (function() {
        ...
        module.exports = XMLElement = (function(superClass) {
          ...
          XMLElement.prototype.clone = function() {
            let att, attName, clonedSelf, ref1;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let DocumentPosition, NodeType, XMLCData, XMLComment, XMLDeclaration, XMLDocType, XMLDummy, XMLElement, XMLNamedNodeMap, XMLNode, XMLNodeList, XMLProcessingInstruction, XMLRaw, XMLText, getValue, isEmpty, isFunction, isObject, ref1,
          hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLNode = (function() {
          ...
          XMLNode.prototype.element = function(name, attributes, text) {
            let childNode, item, j, k, key, lastChild, len, len1, ref2, ref3, val;
            lastChild = null;
          ...
          XMLNode.prototype.insertBefore = function(name, attributes, text) {
            let child, i, newChild, refChild, removed;
          ...
          XMLNode.prototype.instruction = function(target, value) {
            let insTarget, insValue, instruction, j, len;
            if (target != null) {
              target = getValue(target);
            }
            if (value != null) {
          ...
          XMLNode.prototype.dtd = function(pubID, sysID) {
            let child, doc, doctype, i, j, k, len, len1, ref2, ref3;
            doc = this.document();
          ...
          XMLNode.prototype.isDescendant = function(node) {
            let child, isDescendantChild, j, len, ref2;
            ref2 = this.children;
            for (j = 0, len = ref2.length; j < len; j++) {
              child = ref2[j];
              if (node === child) {
      ...
      (function() {
        ...
        module.exports = XMLStreamWriter = (function(superClass) {
          ...
          XMLStreamWriter.prototype.document = function(doc, options) {
            let child, i, j, k, len, len1, ref, ref1, results;
            ref = doc.children;
          ...
          XMLStreamWriter.prototype.element = function(node, options, level) {
            let att, child, childNodeCount, firstChildNode, j, len, name, prettySuppressed, ref, ref1;
            level || (level = 0);
            this.openNode(node, options, level);
            options.state = WriterState.OpenTag;
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let NodeType, WriterState, XMLCData, XMLComment, XMLDTDAttList, XMLDTDElement, XMLDTDEntity, XMLDTDNotation, XMLDeclaration, XMLDocType, XMLDummy, XMLElement, XMLProcessingInstruction, XMLRaw, XMLText, XMLWriterBase, assign,
          hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLWriterBase = (function() {
          ...
          XMLWriterBase.prototype.filterOptions = function(options) {
            let filteredOptions, ref, ref1, ref2, ref3, ref4, ref5, ref6;
            options || (options = {});
          ...
          XMLWriterBase.prototype.element = function(node, options, level) {
            let att, child, childNodeCount, firstChildNode, i, j, len, len1, name, prettySuppressed, r, ref, ref1, ref2;
            level || (level = 0);
            prettySuppressed = false;
            r = '';
            this.openNode(node, options, level);
...
// Generated by CoffeeScript 1.12.7
      (function() {
        let NodeType, WriterState, XMLDOMImplementation, XMLDocument, XMLDocumentCB, XMLStreamWriter, XMLStringWriter, assign, isFunction, ref;
...
/******/ })()
;
//# sourceMappingURL=bundledPlugins/gamestore-origin/gamestore-origin.js.map